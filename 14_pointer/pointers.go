...
func changeNumWithPointer(num *int) { // "*" jo hai num variable jo recieve hoga uska address hai basically
...
func main() {
	...
	fmt.Println("the memory addres of 3 is:", num)

	// pass by reference example
	changeNumWithPointer(&num) // "&num" because ye function ek pointer expect kar rahi hai means pointer and memory address "&" lagake get karte hai 
